...
public:
    ...
    QLabel *label_13;
    QPushButton *generateSummaryReportButton;
    QPushButton *generateGraphicalReportButton;
    QMenuBar *menubar;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        label_11->setGeometry(QRect(330, 20, 151, 16));
        ...
        generateSummaryReportButton = new QPushButton(viewExpensePage);
        generateSummaryReportButton->setObjectName("generateSummaryReportButton");
        generateSummaryReportButton->setGeometry(QRect(550, 30, 181, 32));
        generateGraphicalReportButton = new QPushButton(viewExpensePage);
        generateGraphicalReportButton->setObjectName("generateGraphicalReportButton");
        generateGraphicalReportButton->setGeometry(QRect(550, 70, 181, 32));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        generateSummaryReportButton->setText(QCoreApplication::translate("MainWindow", "Generate Summary Report", nullptr));
        generateGraphicalReportButton->setText(QCoreApplication::translate("MainWindow", "Generate Graphical Report", nullptr));
    } // retranslateUi
